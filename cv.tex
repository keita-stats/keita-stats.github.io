...
Presentation: ``Aitchison幾何学に基づく正方分割表の対称性と歪対称性'', Japanese Society of Applied Statistics Annual Conference, Kyushu University.
...
[1] K. Nakamura: ``Visualizing symmetric and skew-symmetric interactions in square compositional tables'', \textit{11th International Workshop on Compositional Data Analysis (CoDaWork2026)}, Hotel Vila Galé Coimbra, Coimbra, Portugal, 2026.

\vspace{0.3em}
[2] K. Nakamura, T. Nakagawa, K. Tahata: ``Aitchison geometric characterization of quasi-symmetry in square contingency tables'', \textit{CFE-CMStatistics}, Birkbeck, University of London, London, UK, 2025.

\vspace{0.3em}
[3] K. Nakamura, T. Nakagawa, K. Tahata: ``Geometric Marginal Homogeneity in Compositional Tables Based on Simplicial Geometry'', \textit{Further Developments of Information Geometry}, The University of Tokyo, Tokyo, Japan, 2025 (Poster session).

\vspace{0.3em}
[4] K. Nakamura, T. Nakagawa, K. Tahata: ``Orthogonal decomposition of probability tables with Aitchison geometry for symmetry assessment'', \textit{CFE-CMStatistics}, King's College London, London, UK, 2024.
...
[1] \textbf{SPRING Fellowship, Japan Science and Technology Agency (JST)} \hfill \textit{2024 -- Present}\\
Support for Pioneering Research Initiated by the Next Generation (SPRING), Tokyo University of Science
